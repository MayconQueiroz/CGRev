...
public class Objeto implements Serializable{
  ...
  public Color BG = Color.WHITE;//= Color.grayRgb(240); //Cor de fundo (Cor do objeto)
  ...
  ////////////////////////////////////// Senzala: Metodos de manipulacao de faces (ja que elas nao conseguem se manipular)
   ...
   * @param f Face a ser calculado
   * @return Ponto vetor
   */
  public Ponto NormalFace(Face f){
    return new Ponto();
  }
}
