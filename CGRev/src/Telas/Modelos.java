...
public class Modelos extends javax.swing.JFrame {
  ...
  private void lstModelosValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_lstModelosValueChanged
    ...
    if (lstModelos.getSelectedIndex() == 0){ //Cilindro
      ...
      String input = JOptionPane.showInputDialog("Numero de segmentos de meia revolução:");
      if (input.isEmpty()){
        ...
        if (Num < 2){
          ...
          Num = 100;
          double teta = -1.571;
          double passo = 3.14 / (Num);
          for(int i = 0; i < Num+1; i++){
            arPonto.add(new Ponto(round(Math.cos(teta)*40), round(Math.sin(teta)*40+98)));
            teta += passo;
          }
        } else {
          double teta = -1.571;
      ...
      String input2 = JOptionPane.showInputDialog("Distancia do centro do eixo (31~229):");
      if (input.isEmpty() || input2.isEmpty()){
        ...
        if (Num < 3){
          ...
          Num = 100;
          double teta = -1.571;
          double passo = 6.28 / Num;
          for(int i = 0; i < Num+1; i++){
            arPonto.add(new Ponto(round(Math.cos(teta)*30+Dis), round(Math.sin(teta)*30+98)));
